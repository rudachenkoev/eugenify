...
<template>
  <div class="e-loader flex items-center" role="status">
    <svg :class="['e-loader__spinner animate-spin', sizeClasses.spinner, colorClasses]" aria-hidden="true" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <slot name="text">
      <span :class="['e-loader__text', noText ? 'sr-only' : sizeClasses.text]">{{ text }}</span>
    </slot>
  </div>
</template>

...
<template>
  <div class="flex items-center" role="status">
    <svg :class="[sizeClasses.spinner, colorClasses, 'animate-spin']" aria-hidden="true" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <span :class="noText ? 'sr-only' : sizeClasses.text">{{ text }}</span>
  </div>
</template>
